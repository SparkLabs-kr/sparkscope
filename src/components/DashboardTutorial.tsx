...
export const INTER_TOUR: TourStep[] = [
  ...
  },
  {
    key: 'inter-now',
    title: '지금 뭐가 뜨고 있나',
    body: '왼쪽 **📰 지금 주목받는 뉴스**는 신뢰할 수 있는 매체 20여 곳이 지금 무엇을 다루는지 보여줍니다.\n여러 매체가 함께 다룰수록 위로 올라오고, 제목을 누르면 쉬운 말 요약이 펼쳐져요. 우리 포트폴리오사가 걸리면 **왜 걸리는지 이유까지** 함께 붙습니다.\n\n오른쪽 **🔥 소셜 시그널**은 Hacker News·Reddit에서 이 분야 종사자들이 지금 실제로 이야기하는 글입니다. 기사보다 며칠 먼저 움직여요.\n\n둘 다 처음엔 3건만 보이고, 더 보고 싶으면 아래 버튼으로 펼칩니다.',
  },
  {
    key: 'inter-filter',
