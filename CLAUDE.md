...
- 일정: 매일 06:13 KST (UTC 21:13) — 정각(0분)은 GitHub 전역 혼잡으로 매일 ~1시간씩 지연돼서 2026-08-05에 07:07로 이동했으나, 2026-08-06에 그마저도 지연(08:14 시작·09:08 종료)돼 발송 크론 전 완료를 보장하기 위해 06:13으로 재조정함. 기사 발행량이 06~11시에 집중돼(특히 08~10시 최고조) 이보다 더 이르게 당기면 그 물량을 놓치므로 이 정도가 절충선.
